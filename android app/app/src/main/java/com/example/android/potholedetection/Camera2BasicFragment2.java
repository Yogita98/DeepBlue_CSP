...
public class Camera2BasicFragment2 extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        //view.findViewById(R.id.btnTakePicture).setVisibility(View.GONE);
...
//                    getActivity(), new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, SyncStateContract.Constants.WRITE_EXTERNAL_STORAGE);
//        } else {
//            callMethod();
//        }
//    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(
                    getActivity(), new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE},1024);
        }

            String pathD = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + Environment.DIRECTORY_PICTURES+ "/";
        File mediaStorageDir = new File(pathD);
...
//    public void side1(){
//        if(Reportpothole.side1==1) {
//            Log.d("hey","hi");
//            Reportpothole.side1=0;
//            Intent intent = new Intent(getActivity(), sideview1.class);
//            startActivity(intent);
//        }
//        else if(Reportpothole.side1==0){
//            Log.d("ok","bye");
//            Intent intent = new Intent(getActivity(), serverupload.class);
//            startActivity(intent);
//        }
//    }
